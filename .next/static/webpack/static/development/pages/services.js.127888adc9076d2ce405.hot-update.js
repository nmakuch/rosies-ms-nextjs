...
/* harmony import */ var _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/parse-float */ "./node_modules/@babel/runtime-corejs2/core-js/parse-float.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var _components_GlobalHeader__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../components/GlobalHeader */ "./components/GlobalHeader.js");
...
/* harmony import */ var react_scrollable_anchor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! react-scrollable-anchor */ "./node_modules/react-scrollable-anchor/lib/index.js");
...
function _templateObject24() {
  var data = Object(_babel_runtime_corejs2_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_6__["default"])([" margin-bottom: 50px !important;"]);
...
function _templateObject23() {
  var data = Object(_babel_runtime_corejs2_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_6__["default"])([" margin-bottom: 15px !important;"]);
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var addOnsLabels3 = inputs.labelsAddOns3;
  var addOnsCost3 = inputs.optionsAddOns3;
  ...
  var checkBoxArrayIds3 = ["Deep Clean - Wall, baseboards, kitchen...", "Big task - Oven", "Big task - Inside fridge", "Big task - Windows", "Additional powder room", "Additional bathroom"];
  var radioValues1 = [52.5, 70.0, 87.5, 105.0, 122.0, 140.0];
  ...
  var radioValues2 = [52.5, 87.5, 105.0];
  var radioLabels2 = ["Basic (1.5 hours): kitchen, bathroom, all floors  ($52.50)", "Basic Plus (2.5 hours): kitchen, bathroom, living areas including bedroom ($87.50)", "Complete (3.0 hours): kitchen, bathroom, living areas plus one big job ($105.00)"];
  ...
  var radioValues4 = ["8:00am - 10:00am", "10:00am - 12:00pm", "12:00pm - 2:00pm", "2:00pm - 4:00pm"];
  var grandTotalArr = [];
  var sumOptionsAddOns3 = inputs.optionsAddOns3.reduce(function (a, b) {
    return a + b;
  }, 0);
  ...
  var grandTotalHST = formatter.format(reducedArr * 0.13 + inputs.radioLabel * 0.13);
  var grandTotalSumHST = formatter.format(reducedArr * 1.13 + inputs.radioLabel * 1.13);
  ...
  var handleOnChange = function handleOnChange(e) {
    ...
    setInputs(function (prev) {
      return _objectSpread({}, prev, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])({}, e.target.id, e.target.value));
    });
    setStatus({
      submitted: false,
      submitting: false,
  ...
  var handleRadio = function handleRadio(e) {
    e.persist();
    if (e.target.value) setInputs(function (prev) {
  ...
  var handleYesNo1 = function handleYesNo1(e) {
    e.persist();
    if (e.target.value) setInputs(function (prev) {
      return _objectSpread({}, prev, {
        pets: e.target.value
  ...
  var handleYesNo2 = function handleYesNo2(e) {
    e.persist();
    if (e.target.value) setInputs(function (prev) {
      return _objectSpread({}, prev, {
  ...
  var handleYesNo3 = function handleYesNo3(e) {
    e.persist();
    if (e.target.value) setInputs(function (prev) {
      return _objectSpread({}, prev, {
  ...
  var handleCheckBox = function handleCheckBox(e) {
    var checkedArrayAddOns3 = inputs.optionsAddOns3;
    var checkedArrayIds3 = inputs.labelsAddOns3;
    var radioLabel = inputs.radioLabel;
    var radioValue = inputs.radioValue;
    var selectedId3 = e.target.id;
    var selectedValue3 = e.target.value;
    e.persist();

    if (e.target.checked === true) {
      checkedArrayIds3.push(selectedId3);
      checkedArrayAddOns3.push(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_10___default()(selectedValue3));
      setInputs(function (prev) {
        return _objectSpread({}, prev, {
  ...
  return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])(_components_Layout__WEBPACK_IMPORTED_MODULE_14__["default"], {
    ...
    return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("li", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 455
      },
      ...
      id: radioValue,
      checked: inputs.radioValue === "".concat(radioArrayId1[i]),
    ...
    return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("li", {
      ...
      id: radioValue,
      checked: inputs.radioValue === "".concat(radioArrayId2[i]),
      onChange: handleRadio,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 496
    ...
    return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("li", {
      ...
      id: radioValue,
      checked: inputs.radioValue === "".concat(radioArrayId3[i]),
      onChange: handleRadio,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 521
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject7()),
    className: "col-md-12 col-sm-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 543
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject8()),
    className: "row",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 550
    ...
    __self: this
  }, "Add ons:")), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("div", {
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject10()),
    className: "row",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 580
    ...
    return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("label", {
      className: "checkbox-label",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 612
    ...
    return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("li", {
      ...
      value: radioValue,
      id: radioValue,
      checked: inputs.startTime === "".concat(radioValue),
      onChange: handleTime,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 693
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject19()),
    className: "checkbox-label",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 721
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject21()),
    className: "checkbox-label",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 762
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject22()),
    className: "checkbox-label",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 780
    ...
    __self: this
  }, "Note:"), " ", Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("a", {
    href: "#",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 803
    ...
    __self: this
  }, "Please make sure you are inside our service area."), " ", "If you are outside, please give us a call at 437-777-MAID."), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("div", {
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject25()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 807
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject26()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 825
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject27()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 842
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject28()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 862
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject29()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 880
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject30()),
    className: "form-group",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 898
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject31()),
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject32()),
    className: "row",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 944
    ...
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject33()),
    className: "col-md-12 col-sm-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 950
    ...
    __self: this
  }, "For higher areas, such as when cleaning windows and the inside of high cabinets, we will not use anything but a Three-Step ladder for the safety of our staff."))))), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("h4", {
    css: Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["css"])(_templateObject38()),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 1159
    },
    __self: this
  }, "All the items listed above will be available during our cleaner's visit"), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("ul", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 1168
    },
    ...
    __self: this
  })))))), grandTotalHST !== "$0.00" ? Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 1205
    },
    ...
    __self: this
  }, "On future bookings, save 25% by having a scheduled appointment within 2 weeks of your last service, or 10% within 30 days.")) : null, Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])("button", {
    ...
    __self: this
  }, !status.submitting ? !status.submitted ? "Book now" : "Your appointment has been booked!" : "Booking..."))))))), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_12__["jsx"])(_components_CallToAction__WEBPACK_IMPORTED_MODULE_15__["default"], {
...
//# sourceMappingURL=services.js.127888adc9076d2ce405.hot-update.js.map